...
#================================
#definition des matériauxde reference
#------------------------------------
#
MATERIALS = OPER (nom = "MATERIALS",
            ...
            NATURE = SIMP(statut='o',
                          typ='TXM',
	                  into=("MAT_REF_COND1","MAT_REF_COND2","MAT_REF_DIEL1","MAT_REF_DIEL2",
...
#------------------------------------
  mat_ref_c1_properties = BLOC(condition="NATURE=='MAT_REF_COND1'",
	         ...
	         ISOTROPIC       = SIMP (statut="f",
 	         ...
 	         LAW             = SIMP (statut="o",
                ...
                param_sigma1 = BLOC(condition="LAW=='SIGMA1'",
	              ...
	              TYPE_VALUE = SIMP (statut="o",
		                         typ="TXM", 
		                         defaut="COMPLEX",
		                         into = ("REAL","COMPLEX"),
                                         ang = "enter the type of the value",
                                         fr  = "entrer le type de la valeur",
				        ),
		 
                           b_REAL    = BLOC (condition="TYPE_VALUE=='REAL'",
                           ...
                           b_COMPLEX = BLOC (condition="TYPE_VALUE=='COMPLEX'",
...
#------------------------------------------------
     PERMEABILITY = FACT ( statut="o", 
	         ...
	         LAW             = SIMP (statut="o",
                ...
                param_mu1 = BLOC(condition="LAW=='MU1'",
                      TYPE_LAW   = SIMP (statut="o",
				         ...
				         defaut="LINEAR_REAL",
                           ...
                           b_REAL    = BLOC (condition="TYPE_LAW=='LINEAR_REAL'",
	                               VALUE_REAL = SIMP (statut="o",
		                                          typ="R", 
		                                          defaut=1,
                                                          ang = "enter a real relative value",
                           ...
                           b_COMPLEX = BLOC (condition="TYPE_LAW=='LINEAR_COMPLEX'",
	                               VALUE_COMPLEX  = SIMP (statut="o",
		                                         typ="C", 
		                                         defaut=('RI',1,0),
                                                         ang = "enter a complex relative value",
                ...
                param_mu3 = BLOC(condition="LAW=='MU3'",
                      TYPE_LAW   = SIMP (statut="o",
		                         typ="TXM",
...
#------------------------------------
  mat_ref_d1_properties = BLOC(condition="NATURE=='MAT_REF_DIEL1'",
...
#------------------------------------
  mat_ref_z1_properties = BLOC(condition="NATURE=='MAT_REF_ZSURF1'",
...
#----------------------------------------
   mat_ref_i1_properties=BLOC(condition="NATURE=='MAT_REF_EM_ISOTROPIC1'", 
...
#----------------------------------------
   mat_ref_a1_properties=BLOC(condition="NATURE=='MAT_REF_EM_ANISOTROPIC1'",
