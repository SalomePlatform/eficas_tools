dicoCataToEngTelemac = {
    ...
    "CONSTANT_FOR_HEAT_TRANSFER_BETWEEN_TURBULENT_WATER_AND_ICE" : "CONSTANT FOR HEAT TRANSFER BETWEEN TURBULENT WATER AND ICE",
    "CONSTANT_FOR_HEAT_TRANSFER_FOR_SUPERCOOLED_TURBULENT_FLOW" : "CONSTANT FOR HEAT TRANSFER FOR SUPERCOOLED TURBULENT FLOW",
    "NUSSELT_NUMBER_FOR_HEAT_TRANSFER_BETWEEN_LAMINAR_WATER_AND_ICE" : "NUSSELT NUMBER FOR HEAT TRANSFER BETWEEN LAMINAR WATER AND ICE",
