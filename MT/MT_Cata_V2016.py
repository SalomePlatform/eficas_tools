...
############################# DIRECTION ########################################
DIRECTION = MACRO(nom = "DIRECTION",
                  op = None,
                  sd_prod = Direction,
                  reentrant = 'n',
                  UIinfo = {"groupes": ("Machine tournante",)},
                  fr = "Renseignement de la direction de la ligne d'arbres",
                  AXE = SIMP(statut = 'o',
                             typ = 'TXM',
                             fr = "Direction de l'axe de la ligne d'arbres",
                             min=1,
                             max=1,
...
# recuperation depuis une biblioth̬que de materiau => sera specife
# plus tard
...
LIGNE_ARBRE = MACRO(nom = 'LIGNE_ARBRE',
                    ...
                    DIRECTION = SIMP(statut='o',
                                     fr = "Direction de la ligne d'arbres consideree (choisir une des entrees DIRECTION creees)",
                                     typ=Direction,
                                     min=1,
                                     max=1,
                                     ), # end DIRECTION
