...
output_grid_field_csv_metadata=SIMP(typ='TXM',fr='',ang='CVS formated grid metadata',statut='o',docu='',into=None,min=1,max=1,val_min='**',val_max='**',defaut=None),
...
output_grid_field_csv=SIMP(typ='TXM',fr='',ang='CVS formated grid',statut='o',docu='',into=None,min=1,max=1,val_min='**',val_max='**',defaut=None),
