...
class CONFIG:
  ...
  # dans le fichier general sinon
      ...
      # Valeurs par defaut
      self.rep_user     = os.path.join(os.environ['HOME'],'.Eficas_Map')
      ...
      self.labels_user=('exec_acrobat', 'catalogues','savedir','path_doc','map_path','PATH_PYGMEE','PATH_BENHUR')
      self.labels_eficas=("map_path","rep_user","INSTALLDIR","path_doc","exec_acrobat","rep_cata","initialdir","savedir","catalogues",'PATH_PYGMEE','PATH_BENHUR')
  ...
  #--------------------------------------
      ...
      fic_ini = os.path.join(self.repIni,"catalogues_Map.ini")
